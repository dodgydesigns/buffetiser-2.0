...
@app.get("/")
def read_root():
    _logger.info("API Status: Running")
    return {"API Status": "Running"}



@app.get("/all")
def read_all_investments():
    _logger.info("All investments endpoint hit")
    return {"all_investment_data": all_investment_data}
...
# This is a test endpoint for debugging raw request bodies, etc. Can be removed later.
# @app.post("/test")
